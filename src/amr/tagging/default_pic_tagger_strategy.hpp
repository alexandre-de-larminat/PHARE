#ifndef DEFAULT_PIC_TAGGER_STRATEGY_H
#define DEFAULT_PIC_TAGGER_STRATEGY_H
...
class DefaultPICTaggerStrategy : public PICTaggerStrategy<PICModel>
{
    using gridlayout_type           = typename PICModel::gridlayout_type;
    static auto constexpr dimension = PICModel::dimension;

public:
    void tag(PICModel& model, gridlayout_type const& layout, int* tags) const override;
};

template<typename PICModel>
void DefaultPICTaggerStrategy<PICModel>::tag(PICModel& model,
