...
def make_figure():
    ...
    rwT = Run("./withTaggingPIC")
    rNoRef = Run("./noRefinementPIC")
...
def main():
    #Simulator(noRefinement(diagdir="noRefinementPIC")).run()
    #ph.global_vars.sim = None

    Simulator(withTagging(diagdir="withTaggingPIC"), post_advance=post_advance).run()
    ph.global_vars.sim = None
