...
field_qties = {
    ...
    "bulkVelocity_y": "Vy",
    "bulkVelocity_z": "Vz",
    "electron_bulkVelocity_x": "Vex",
    "electron_bulkVelocity_y": "Vey",
    "electron_bulkVelocity_z": "Vez",
...
def quantidic(ilvl, wrangler):
    ...
    return {
        ...
        "electron_bulkVelocity_x": pl.getVex,
        "electron_bulkVelocity_y": pl.getVey,
        "electron_bulkVelocity_z": pl.getVez,
        "EM_B_x": pl.getBx,
        "EM_B_y": pl.getBy,
        "EM_B_z": pl.getBz,
        "EM_E_x": pl.getEx,
...
def isFieldQty(qty):
    return qty in (
        ...
        "bulkVelocity_y",
        "bulkVelocity_z",
        "electron_bulkVelocity_x",
        "electron_bulkVelocity_y",
        "electron_bulkVelocity_z",
        "EM_B_x",
        "EM_B_y",
        "EM_B_z",
        "EM_E_x",
